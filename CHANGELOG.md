...
- Runs snyk to check for vulnerable dependencies. Installs snyk as a devDependency and adds snyk:test to npm scripts. [PR 72](https://github.com/input-output-hk/react-polymorph/pull/72)
